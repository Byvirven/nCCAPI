...
int main() {
    ...
    HuobiCoinSwap exchange(session);
    ...
    std::cout << "Testing exchange: huobi-coin-swap" << std::endl;
    ...
    if (candles.size() > 2005) {
        ...
        std::cout << "\033[31m[FAIL] Received " << candles.size() << " candles (Expected > 2000). Known limitation.\033[0m" << std::endl;
    }
